    ...
    try {
      if (!editId) {
        const result = await axios.post(
          "http://3.144.24.244:3000/addExpense",
          expenseData,
          {
            headers: {
        ...
        const response = await axios.post(
          `http://3.144.24.244:3000/updateExpense/${editId}`,
          expenseData,
          {
            headers: {
              authorization: localStorage.getItem("Authorization"),
...
async function dailyDateList(startDate, endDate) {
  ...
  try {
    const response = await axios.get(
      `http://3.144.24.244:3000/getExpenseList/${startDate}/${endDate}`,
      {
        params: {
    ...
    if (
      response.data.lastPage != dailyPageNumber &&
      response.data.hasNextPage
    ) {
...
async function buyPremium(e) {
  try {
    const payment = await axios.get(
      "http://3.144.24.244:3000/purchase/buyPremium",
      {
        headers: {
          authorization: localStorage.getItem("Authorization"),
        },
    ...
    var options = {
      ...
      handler: async function (payment) {
        await axios
          .post(
            "http://3.144.24.244:3000/purchase/updatePaymentStatus",
            {
...
async function editExpense(id) {
  editId = id;
  const response = await axios.get(
    `http://3.144.24.244:3000/getExpense/${id}`,
    {
      headers: {
        authorization: localStorage.getItem("Authorization"),
      },
...
async function deleteExpense(id) {
  const deletedExpense = await axios.delete(
    `http://3.144.24.244:3000/deleteExpense/${id}`,
    {
      headers: {
        authorization: localStorage.getItem("Authorization"),
      },
...
async function downloadReport() {
  try {
    const response = await axios.get(
      "http://3.144.24.244:3000/expense/downloadAllExpenses",
      {
        headers: {
          authorization: localStorage.getItem("Authorization"),
        },
